...
<div class="toggle faq">
        <div class="togglet">
                ...
                <a name="faq8"></a>
                                <h4>Why is there a "Power Waving" interference on the video image?
</h4>        </div>
        <div class="togglec" style="display: none;">
                        <h3><p>Coaxial cabling either Twisted pair cabling may have "Power Waving" interferences, that most from High Frequency (such as radio) or Differences in ground potentials are typically caused by unbalanced power line loads. Then you could add our "Video Ground Loop Isolator" to eliminate the interference.<br>Generally, it is not easy to find out where this kind of interference from, so we would recommend use monitor to check each connecting point (between two wire connection), to find out where is the source of interference.<br>To block the interference from electromagnetic wave, high voltage electricity, wireless station, with Video Transformer Filter function. That you could use new model: CHB001.</p>
</h3>        </div>
</div>
<div class="toggle faq">
        <div class="togglet">
                ...
                <a name="faq7"></a>
                                <h4>Why the color become light or video image not stable, even no video image after connecting DVR, but the video image is good while into monitor directly?
</h4>        </div>
        <div class="togglec" style="display: none;">
                        <h3><p>Video signal would be degradation once through any cable transmission, either coaxial or twisted pair wire. Especially the video signal through DVR (analog to digital signal) that signal loss would be bigger. If the video signal output less than 0.8Vpp, the picture display would lack quality and have bad or ghost video image. You could use our following products for improvement.<br>1.For Coaxial cabling, you could add our video amplifier CA101/CA101A/CA404/CA101VH...etc at the front of DVR. To boost the video signal.<br>2.For twisted pair cabling, you could alternate the passive receiver to active type TTA111VR/TTA111AVR/TTA414VR/TPA008/TPA016, which built in brightness and sharpness controls. If range is over 1.5Km, you could add one more sets active video transmitter/receiver for series connection.</p>
</h3>        </div>
</div>
<div class="toggle faq">
        <div class="togglet">
                ...
                <a name="faq6"></a>
                                <h4>When one video image need distribute to 2 monitoring. the monitor picture looks ok, but into the DVR, video picture not stable or color become B/W?
</h4>        </div>
        <div class="togglec" style="display: none;">
                        <h3><p>One Video signal split into 2 channels that the signal would be degradation to cause the picture not stable. Please use our Video Distributor CD102/CD408/CD816 which make amplify and stable video signal before distribute the signal. If there are multi video channels and the transmission range are big different, you could use our Video Distribution Amplifier CD102A/CD408A/CD816A which built in HI frequency compensation and sharpness, brightness controls for high quality picture on different range transmission.</p>
</h3>        </div>
</div>
<div class="toggle faq">
        <div class="togglet">
...
<div class="toggle faq">
        <div class="togglet">
                ...
                <a name="faq4"></a>
                                <h4>Why the video image is wavy and shaking under one channel transmission application?
</h4>        </div>
        <div class="togglec" style="display: none;">
                        <h3><p>Wrong twisted pair cable connection would cause the video image wavy and shaking if only use one pair wire for one channel video transmission, please check the cable connection and make sure the TX wire and RX wire must be equivalent. (Example: TX: 1, 2 = RX: 1, 2 or TX: 7,8 = RX: 7,8).</p>
</h3>        </div>
</div>
<div class="toggle faq">
        <div class="togglet">
                ...
                <a name="faq3"></a>
                                <h4>Why the camera and video transceivers at out-door have higher defective rate and quality not stable?
</h4>        </div>
        <div class="togglec" style="display: none;">
                        <h3><p>Normally, the cabling at out-door and have long range transmission for camera. That would have higher rate on surge or lighting damage, even some of our products built in TVS (Transient Diode for Surge Protection), but the products still damaged once have stronger surge or lighting. We strongly recommend to add our surge (Lighting) protector.</p>
</h3>        </div>
</div>
<div class="toggle faq">
        <div class="togglet">
